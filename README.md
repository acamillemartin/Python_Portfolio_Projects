# Python Projects
This repository contains my Python projects focused on data cleaning, exploratory data analysis (EDA), and web scraping.
These projects showcase my ability to work with real-world datasets, extract data from websites, and analyze patterns using Python.

Each project includes clear code, comments, and documented steps that explain my approach and lessons learned.
